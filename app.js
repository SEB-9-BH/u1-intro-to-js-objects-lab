...
game.party.push(pokemon[57], pokemon [66], pokemon [74])
...
game.party.splice(0,4,pokemon[25],pokemon[58],pokemon[67],pokemon[75])
...
const ItemPokeball= game.items.find (item => item.name === 'pokeball')
...
console.log(partyCount.pokenum)
