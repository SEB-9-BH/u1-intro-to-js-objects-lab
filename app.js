...
objects have a value of `false` on their `completed` property, the logged value would be:
...
game.partyCount = function () {
   let partypoke = game.party.length;
   return partypoke;
}
